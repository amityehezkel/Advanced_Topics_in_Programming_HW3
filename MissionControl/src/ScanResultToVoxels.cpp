...
namespace mission_control_212200943
{
                                        ...
                                        const types::LidarConfigData &lidar_config)
    {
        ...
        // The drone's center is known free. This also prevents a below-z_min beam
        // from marking the sensor's own voxel as potentially occupied.
        output_map.set(scan_origin, types::VoxelOccupancy::Empty);
